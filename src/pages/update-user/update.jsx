...
const UpdateUser = () => {
  ...
  return (
    <div className="max-w-[1200px] m-auto">
      <form onSubmit={handleSubmit} className="w-[90%] sm:w-[50%] md:[90%] m-auto mt-15 border border-gray-100 rounded">
       <div className="px-3 pt-3 flex gap-3">
        <button onClick={()=>navigate("/")}><ArrowLeft/></button>
        <h1 className="font-bold">Back To Table</h1>
       </div>
        <div className=" flex flex-col gap-3  shadow-xl rounded-[5px] p-5 h-[470px] justify-center">
